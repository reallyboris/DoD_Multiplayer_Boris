...
country = {
	...
	NEWSPAPER_PRINTING_FREQUENCY = 36500, -- days frequency when the news attempt to be printed (may not print if not enough facts collected, and retry after another X days)
	NEWSPAPER_TIMEOUT_PERIOD = 36500, -- the max period for news that may be printed. The probability is decreased with time.
	NEWSPAPER_MAX_TENSION = 36500, -- when tension of printing gets this high, the newspaper will attempt to be printed immediately.
...
diplomacy = {
	...
	BREAKTRUCE_INFAMY_ADD_TO_SPHERE = 3,
	BREAKTRUCE_INFAMY_RELEASE_PUPPET = 3,
	BREAKTRUCE_INFAMY_MAKE_PUPPET = 3,
	BREAKTRUCE_INFAMY_DISARMAMENT = 3,
	BREAKTRUCE_INFAMY_DESTROY_FORTS = 3,
	BREAKTRUCE_INFAMY_DESTROY_NAVAL_BASES = 3,
	BREAKTRUCE_INFAMY_REPARATIONS = 3,
	BREAKTRUCE_INFAMY_TRANSFER_PROVINCES = 3,
	BREAKTRUCE_INFAMY_REMOVE_CORES = 0,
	BREAKTRUCE_INFAMY_PRESTIGE = 3,
	BREAKTRUCE_INFAMY_CONCEDE = 3,
	BREAKTRUCE_INFAMY_STATUS_QUO = 3,
	BREAKTRUCE_INFAMY_ANNEX = 3,
	BREAKTRUCE_INFAMY_DEMAND_STATE = 3,
	BREAKTRUCE_INFAMY_INSTALL_COMMUNIST_GOV_TYPE = 3,
	BREAKTRUCE_INFAMY_UNINSTALL_COMMUNIST_GOV_TYPE = 3,
	BREAKTRUCE_INFAMY_COLONY = 3,
